...
TRAIN_PATH = "../../datasets/bicep_curl_dataset/train.csv"
TEST_PATH = "../../datasets/bicep_curl_dataset/test.csv"
...
def load_datasets():
    ...
    print("\nBicep curl train dataset loaded.")
    print("Train shape:", train_df.shape)
    print("Train columns:", train_df.columns.tolist())

    print("\nBicep curl test dataset loaded.")
...
def prepare_data(train_df, test_df):
    ...
    # Convert short labels into readable labels
    train_df["label_name"] = train_df["label"].map(LABEL_MAP)
    test_df["label_name"] = test_df["label"].map(LABEL_MAP)

    # If any unknown label exists, keep original label
...
def train_model(X_train, y_train):
    ...
    print("\nTraining Bicep Curl Posture Model...")
...
def evaluate_model(model, X_test, y_test):
    ...
    print("\nBicep Curl Model Evaluation Results")
    print("-----------------------------------")
...
def save_model(model, feature_columns, metrics):
    ...
    print("\nBicep curl model saved successfully:")
    print(MODEL_PATH)
...
def main():
    ...
    print("\nBicep curl model training completed successfully.")
