...
TRAIN_PATH = "../../datasets/plank_dataset/train.csv"
TEST_PATH = "../../datasets/plank_dataset/test.csv"
...
def load_datasets():
    ...
    print("\nPlank train dataset loaded.")
    print("Train shape:", train_df.shape)
    print("Train columns:", train_df.columns.tolist())

    print("\nPlank test dataset loaded.")
...
def evaluate_model(model, X_test, y_test):
    ...
    print("\nPlank Model Evaluation Results")
    print("------------------------------")
...
def save_model(model, feature_columns, metrics):
    ...
    print("\nPlank model saved successfully:")
    print(MODEL_PATH)
...
def main():
    ...
    print("\nPlank model training completed successfully.")
